...
abstract public class Permit {
    ...
    public String toString() {
       return "Permit{" + "permitHolder=" + permitHolder + ", noOfEntries=" + noOfEntries +
       ", warnings=" + warnings + ", suspended=" + suspended + ", enteredToday=" + enteredToday + 
        ", vehicleUsedToday=" + vehicleUsedToday + ", permittedVehicles=" + permittedVehicles + '}';
    }
}
